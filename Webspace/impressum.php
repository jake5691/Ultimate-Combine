...
<head>
  ...
  <title>Ultimate Combine – Impressum</title>
...
<body>
  ...
  <header class="topbar">
    ...
    <div class="brand">
      ...
      <span class="brand-team">Impressum</span>
    </div>
    <span></span>
  </header>
  ...
  <main class="team">
    <section class="auth-card">
      <h1>Impressum</h1>
      <p class="lead">Angaben gemäß § 5 TMG und § 18 Abs. 2 MStV und ebenfalls Verantwortlich gemäß § 18 Abs. 2 MStV:</p>
      ...
      <h2>Kontakt</h2>
      <p>
        Telefon: 07032/9543792<br>
        E-Mail: hello@ultimate-combine.de
      </p>
