...
?>
  ...
  <main class="team">
    ...
    <section class="team-grid">
      <?php require __DIR__ . "/partials/team/form-create-player.php"; ?>
      <?php require __DIR__ . "/partials/team/form-create-combine.php"; ?>
      <?php require __DIR__ . "/partials/team/form-create-discipline.php"; ?>
    </section>
    ...
    <?php if ($editType && ($editId || $cloneSourceId)): ?>
      <section class="auth-card" id="edit">
        ...
        <?php elseif ($editType === "player" && $editRecord): ?>
          <?php require __DIR__ . "/partials/team/form-edit-player.php"; ?>
        <?php elseif ($editType === "combine" && $editRecord): ?>
          <?php require __DIR__ . "/partials/team/form-edit-combine.php"; ?>
        <?php elseif ($editType === "discipline" && $editRecord): ?>
          <?php require __DIR__ . "/partials/team/form-edit-discipline.php"; ?>
        <?php endif; ?>
      </section>
    <?php endif; ?>
